const AuthenticationResourceVI = {
  status_away: 'Away',
  ...
  fail_sign_up_username_existed: 'This username is registered already or the username format is invalid.',
...
export default AuthenticationResourceVI;
